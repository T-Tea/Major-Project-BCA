        ...
        <div class="right-container">
          ...
          <div class="dashboard-sections">
            ...
            <div class="upcoming-checkouts">
              <div class="section-header">
                ...
                <button class="view-checkout-btn" onclick="location.href='wCheckout.php'">View All</button>
              </div>
            ...
            <div class="maintenance-requests">
              <div class="section-header">
                ...
                <button class="view-report-btn" onclick="location.href='wReport.php'">View All</button>
              </div>
          ...
          <div class="quick-actions">
            ...
            <div class="action-buttons">
              <button onclick="location.href='wNotification.php'">Send Notification</button>
              <button onclick="location.href='wPayment.php'">View Payments</button>
              <button onclick="location.href='wReport.php'">Check Reports</button>
            </div>
          </div>          
