            ...
            if (data.length > 0) {
                ...
                data.forEach(hosteller => {
                    ...
                    row.innerHTML = `
                        ...
                        <td><button class="toggle-btn ${messFeeClass}" 
                            data-type="mess_fee" onclick="toggleStatus(this)">${hosteller.mess_fee_status}</button></td>
                        <td><button class="toggle-btn ${roomRentClass}" 
                            data-type="room_rent" onclick="toggleStatus(this)">${hosteller.room_rent_status}</button></td>
                    `;
